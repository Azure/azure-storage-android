...
public class CloudQueueClientGB18030Test extends TestCase {
    ...
    // GB18030CharSet is "å•Šé½„ä¸‚ç‹›ç‹œï§±ï¤¬ï§±ï¨Œï¨©ËŠâ–‡â–ˆã€žã€¡ï¿¤â„¡ãˆ±â€�ãƒ¼ï¹¡ï¹¢ï¹«ã€�ã€“â…°â…¹â’ˆâ‚¬ãˆ ãˆ©â… â…«ï¼�ï¿£ã��ã‚“ã‚¡ãƒ¶Î‘ï¸´Ð�Ð¯Ð°Ñ�Ä�É¡ã„…ã„©â”€â•‹ï¸µï¹„ï¸»ï¸±ï¸³ï¸´â…°â…¹É‘îŸ‡É¡ã€‡ã€¾â¿»âº�î¡ƒäœ£î¡¤â‚¬ã�€ã’£ã•´ã•µã™‰ã™Šäµ¯äµ°ä¶´ä¶µ".
