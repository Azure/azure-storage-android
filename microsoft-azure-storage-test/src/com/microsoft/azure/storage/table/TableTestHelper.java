...
public class TableTestHelper extends TestHelper {
    ...
    public static class StrangeDoubles extends TableServiceEntity implements PropertyResolver {
        ...
        public void assertEquality(StrangeDoubles other) {
            ...
            // compare primitives
            Assert.assertEquals(this.getRegularPrimDouble(), other.getRegularPrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getNanPrimDouble(), other.getNanPrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getPositiveInfinityPrimDouble(), other.getPositiveInfinityPrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getNegativeInfinityPrimDouble(), other.getNegativeInfinityPrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getMinValuePrimDouble(), other.getMinValuePrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getMaxValuePrimDouble(), other.getMaxValuePrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getMinExponentValuePrimDouble(), other.getMinExponentValuePrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getMaxExponentValuePrimDouble(), other.getMaxExponentValuePrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getMinNormalValuePrimDouble(), other.getMinNormalValuePrimDouble(), 1.0e-10);
            Assert.assertEquals(this.getZeroValuePrimDouble(), other.getZeroValuePrimDouble(), 1.0e-10);

            // server sets -0.0 to 0.0
            // Assert.assertEquals(this.getNegativeZeroValuePrimDouble(), other.getNegativeZeroValuePrimDouble(), 1.0e-10);

            // compare objects
            Assert.assertEquals(this.getRegularDouble(), other.getRegularDouble());
            Assert.assertEquals(this.getNanDouble(), other.getNanDouble());
            Assert.assertEquals(this.getPositiveInfinityDouble(), other.getPositiveInfinityDouble());
            Assert.assertEquals(this.getNegativeInfinityDouble(), other.getNegativeInfinityDouble());
            Assert.assertEquals(this.getMinValueDouble(), other.getMinValueDouble());
            Assert.assertEquals(this.getMaxValueDouble(), other.getMaxValueDouble());
            Assert.assertEquals(this.getMinExponentValueDouble(), other.getMinExponentValueDouble());
            Assert.assertEquals(this.getMaxExponentValueDouble(), other.getMaxExponentValueDouble());
            Assert.assertEquals(this.getMinNormalValueDouble(), other.getMinNormalValueDouble());
            Assert.assertEquals(this.getZeroValueDouble(), other.getZeroValueDouble());

            // server sets -0.0 to 0.0
            // Assert.assertEquals(this.getNegativeZeroValueDouble(), other.getNegativeZeroValueDouble());
        }
