...
public class TableSerializerTests {
    ...
    @After
    public void tableSerializerTestMethodTearDown() throws StorageException {
    ...
    private void testComplexEntityInsert(TableRequestOptions options, boolean usePropertyResolver) throws StorageException {
