 ...
 * <p>
 * where <em>PropertyName</em> is a property name for the table entity, and <em>type</em> is compatible with
 * the EDM data type of the property. See the table in the class description for {@link TableServiceEntity} for a map of
 * property types to their language equivalents. The {@link StoreAs} annotation may be applied with a <code>name</code>
